...
Run at 2026-09-24T20:18:58.665Z on commit `null` (source revision `8e19e0a07a97824359ed08f5ce2f1c8eb6092a7d`), chromium 153.0.8010.12, 393×852, Asia/Beirut unless a journey sets its own clock and zone.
...
| F74 — Verification method change races with Continue | shipping | 4 | 4 | 0 | [F74-shipping-shipping-fails-closed-before-verification.png](./F74-shipping-shipping-fails-closed-before-verification.png) |
| F74 — Verification method change races with Continue | qa | 9 | 3 | 0 | [F74-qa-after-rapid-choice.png](./F74-qa-after-rapid-choice.png) |
...
| F133 — Unconfirmed market-order recovery can retain the wrong ledger tab | shipping | 4 | 3 | 0 | [F133-shipping-failure.png](./F133-shipping-failure.png) |
| F133 — Unconfirmed market-order recovery can retain the wrong ledger tab | qa | 4 | 3 | 0 | [F133-qa-failure.png](./F133-qa-failure.png) |
...
| F141 — Order ticket repeats closed-market notices and retains distracting context banners | shipping | 9 | 2 | 0 | [F141-shipping-closed-gold-ticket.png](./F141-shipping-closed-gold-ticket.png) |
| F141 — Order ticket repeats closed-market notices and retains distracting context banners | qa | 10 | 1 | 0 | [F141-qa-closed-gold-ticket.png](./F141-qa-closed-gold-ticket.png) |
...
| F147 — Closed position lookup loses continuity with its resulting trade | shipping | 10 | 2 | 0 | [F147-shipping-closed-record.png](./F147-shipping-closed-record.png) |
| F147 — Closed position lookup loses continuity with its resulting trade | qa | 10 | 2 | 0 | [F147-qa-closed-record.png](./F147-qa-closed-record.png) |
...
Totals: 24 findings, 46 runs, 587 checks, 20 failed, 0 blocked.

## Failed and blocked checks

- F74 (shipping) FAILED: shipping: the Verify address typed by the blocked applicant offers no method choice — /onboarding/verify
- F74 (shipping) FAILED: shipping: and lands on the application status — /onboarding/verify
- F74 (shipping) FAILED: shipping: the Verify address typed by the verified client offers no method choice — /onboarding/verify
- F74 (shipping) FAILED: shipping: and lands on the status screen, still verified — /onboarding/verify
- F74 (qa) FAILED: prior-method: a refused save shows the error banner
- F74 (qa) FAILED: prior-method: Continue is refused
- F74 (qa) FAILED: the journey ran to completion — Error: tap verify-method-error-action: TimeoutError: locator.click: Timeout 15000ms exceeded.
- F133 (shipping) FAILED: low-margin fixture: Home shows the margin warning with Review positions
- F133 (shipping) FAILED: market: the ticket advances to review — /trade/ticket?symbol=BTCUSD
- F133 (shipping) FAILED: the journey ran to completion — Error: tap review-submit: TimeoutError: locator.click: Timeout 15000ms exceeded.
- F133 (qa) FAILED: low-margin fixture: Home shows the margin warning with Review positions
- F133 (qa) FAILED: market: the ticket advances to review — /trade/ticket?symbol=BTCUSD
- F133 (qa) FAILED: the journey ran to completion — Error: tap review-submit: TimeoutError: locator.click: Timeout 15000ms exceeded.
- F141 (shipping) FAILED: the existing XAUUSD position is NOT restated on its ticket — 1 line(s)
- F141 (shipping) FAILED: the journey ran to completion — TimeoutError: locator.click: Timeout 15000ms exceeded.
- F141 (qa) FAILED: the journey ran to completion — TimeoutError: locator.click: Timeout 15000ms exceeded.
- F147 (shipping) FAILED: trade-query fixture: the failed history read shows an error with Try again
- F147 (shipping) FAILED: the journey ran to completion — Error: tap error-state-action: TimeoutError: locator.click: Timeout 15000ms exceeded.
- F147 (qa) FAILED: trade-query fixture: the failed history read shows an error with Try again
- F147 (qa) FAILED: the journey ran to completion — Error: tap error-state-action: TimeoutError: locator.click: Timeout 15000ms exceeded.
